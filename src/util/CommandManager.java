...
public class CommandManager {
    ...
    /**
     *
     * @param addCommand команда добавления объекта в коллекцию
     * @param historyCommand команда для просмотра истории вызываемых команд
     * @param exitCommand команда для выхода из программы
     * @param helpCommand команда выводящая все доступные пользавателю названия команд и их описание
     * @param infoCommand команда выводящая информацию о коллекции (количество элементов, тип коллекции, время создания / сохранения объектов)
     * @param showCommand команда выводящая все объекты коллекции
     * @param updateCommand команда позволяющая изменить данные в объекте по его id
     * @param executeScriptCommand команда выполняющая команды по скрипту из файла
     * @param removeByIdCommand команда убирающая объект по его id
     * @param saveCommand команда сохраняющая объекты коллекции в файл json
     * @param clearCommand команда очищающая объекты в коллекции
     * @param addIfMaxCommand добавить новый элемент в коллекцию, если его значение превышает значение наибольшего элемента этой коллекции
     * @param addIfMinCommand добавить новый элемент в коллекцию, если его значение меньше, чем у наименьшего элемента этой коллекции
     */
