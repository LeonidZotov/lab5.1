...
public class Interactor {
     ...
     * @throws IncorrectInputInScriptException при неправильно введенных данных
     */
    ...
    /**
     * @return корректное значение размаха крыльев
     * @throws IncorrectInputInScriptException При неправильно введенных данных
     */
    ...
    /**
     * @return корректное значение возраста
     * @throws IncorrectInputInScriptException при неправильно введенных данных
     */
    ...
    /**
     * @return Корректное значение типа
     * @throws IncorrectInputInScriptException при неправильно введенных данных
     */
    ...
    /**
     * @return Корректное значение характера
     * @throws IncorrectInputInScriptException При неправильно введенных данных
     */
    ...
    /**
     * @return Корректное значение размера головы
     * @throws IncorrectInputInScriptException При неправильно введенных данных
     */
     ...
     * @return метод спрашивающий пользователя
     * @throws IncorrectInputInScriptException при неправильно введенных данных
     */
